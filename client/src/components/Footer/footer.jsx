...
const Footer =()=>{
    ...
    const services=["Professional Certifications","MasterTrack® Certificates","Industrial Courses","For Government","For Campus","Become a Partner"];
    const about=["EduNext","Mobile version","Companies","Learning Partner","Careers"];
    ...
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        <div className="text-black/80 flex ">
          ...
          <h1 className="text-start text-3xl font-semibold items-start">EduNext</h1>
        </div>

        <p className="mt-4 max-w-xs text-gray-500">
        Transforming education with innovative, seamless, and accessible with empowering learning experiences.
        </p>
